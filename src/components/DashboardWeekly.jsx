  ...
  const fetchTemperature = async (
    ...
    try {
      ...
      const formattedData = sortedData.map((entry) => ({
        ...
        temperature: parseFloat(entry.day_temp_value),
        outTemperature: parseFloat(entry.out_day_temp_value),
        settingTemp: parseFloat(entry.setting_day_temp_value),
        current: parseFloat(entry.day_current_value), // 전류 값
